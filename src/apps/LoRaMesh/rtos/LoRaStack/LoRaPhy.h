...
#define LORAPHY_PACKET_FLAGS_ADVERTISING        (1<<3)  /*!< advertising received */
#define LORAPHY_PACKET_FLAGS_JOIN_REQ           (1<<4)  /*!< join request message */
#define LORAPHY_PACKET_FLAGS_ACK_REQ            (1<<5)  /*!< acknowledge requested */
