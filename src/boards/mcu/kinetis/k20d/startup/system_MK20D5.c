...
Default_ISR(Reserved7_IRQHandler){ _DEBUGHALT(); }
Default_ISR(Reserved8_IRQHandler){ _DEBUGHALT(); }
Default_ISR(Reserved9_IRQHandler){ _DEBUGHALT(); }
Default_ISR(Reserved10_IRQHandler){ _DEBUGHALT(); }
Default_ISR(SVC_Handler){ _DEBUGHALT(); }
Default_ISR(DebugMon_Handler){ _DEBUGHALT(); }
Default_ISR(Reserved13_IRQHandler){ _DEBUGHALT(); }
Default_ISR(PendSV_Handler){ _DEBUGHALT(); }
