...
#if defined(FSL_RTOS_FREE_RTOS) || defined(USE_FREE_RTOS)
    TimerInit(&TxTimeoutTimer, "TxTimeoutTimer", 0, 10, SX1276OnTimeoutIrq, false);
    TimerInit(&RxTimeoutTimer, "RxTimeoutTimer", 0, 10, SX1276OnTimeoutIrq, false);
    TimerInit(&RxTimeoutSyncWord, "RxTimeoutSyncWord", 0, 10, SX1276OnTimeoutIrq, false);
#else
