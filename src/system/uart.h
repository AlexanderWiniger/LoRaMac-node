 ...
 */
typedef enum {
    UART_1_STOP_BIT = 0, UART_0_5_STOP_BIT, UART_2_STOP_BIT, UART_1_5_STOP_BIT
} StopBits_t;
 ...
 */
typedef enum {
    NO_PARITY = 0, EVEN_PARITY, ODD_PARITY
} Parity_t;
 ...
 */
typedef enum {
    NO_FLOW_CTRL = 0, RTS_FLOW_CTRL, CTS_FLOW_CTRL, RTS_CTS_FLOW_CTRL
} FlowCtrl_t;
